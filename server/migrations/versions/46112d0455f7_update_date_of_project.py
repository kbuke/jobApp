"""update date of project

Revision ID: 46112d0455f7
Revises: ea451b9074fa
Create Date: 2024-09-30 23:49:33.242087
...
revision = '46112d0455f7'
down_revision = 'ea451b9074fa'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    sa.Column('looking_work', sa.Boolean(), server_default='false', nullable=False),
    ...
    sa.Column('date', sa.Date(), server_default='2005, 3, 15', nullable=False),
